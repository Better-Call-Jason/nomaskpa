...
<head>
    ...
    <meta name="description" content="Is mask wearing safe? Is mask wearing effective? Find lots of great scientific research and get your own medical exception badge if you qualify!">
    <meta name="keywords" content="mask exception, exempt from wearing mask, pa, pennsylvania, universal masking order">
    <meta name="author" content="The Center For Advanced Studies in Health and Wellness Through Sanity">
    <title>Medical Exception To Universal Mask Wearing Order In Pennsylvania</title>
...
<main role="main">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-item active">
                ...
                <div class="container">
                    <div class="carousel-caption text-left">
                        <h1> Do Masks Work? </h1>
                        <p style="text-transform: capitalize ">No, They Don't Help At All. Read Our Riveting Article That Reveals What The Scientists Say About Masks To Each Other In a Comprehensive Fact-Filled Investigation of Scholarly Articles. <br></p>
                        <p><a class="btn btn-lg btn-info" href="#fifthgrader" role="button">Read The Article</a></p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption">
                        <h1>What About The Covid-19 Test?</h1>
                        <p style="text-transform: capitalize">The Test Means nothing if you test positive. It also cannot offer any peace of mind if you test negative. In this article we investigate the test in a way that will leave you shocked at why the results make no sense and prove that the case numbers are meaningless.</p>
                        <p><a class="btn btn-lg btn-info" href="#test" role="button">Read The Article</a></p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="container">
                    <div class="carousel-caption text-right">
                        <h1>What About All The Deaths?</h1>
                        <p style="text-transform: capitalize">The death numbers were exaggerated to fool us all into accepting lock down orders. This article takes a deep dive into the numbers with an amazing analysis of what's really going on and will help you find your way out.</p>
                        <p><a class="btn btn-lg btn-info" href="#numbers" role="button">Read The Article</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <a class="carousel-control-next" href="#myCarousel" role="button" data-slide="next">
            <span  id="top" class="carousel-control-next-icon" aria-hidden="true"></span>
    ...
    <div class="container marketing" id="top">
        <div class="row">
            <div class="col-lg-4">
                <img src="assets/img/theater-masks-duotone.svg" width="75px;" height="75px" alt="">
                <h2>The Mask</h2>
                <p style="text-transform: capitalize"> Mask wearing does not reduce infections or prevent the transmission of disease. Even the N95 doesn't stop viruses.  Mask wearing has been shown to increase infections in clinical settings. The scientific studies and tests are clear on this one : masks do not help. Read this simple, yet powerful explanation about why masks don't work and have been proven to make things worse.</p>
                <p><a class="btn btn-info" href="#fifthgrader" role="button">Get The Facts &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img src="assets/img/flask-potion-duotone.svg" width="75px;" height="75px" alt="">
                <h2 style="text-transform: capitalize;">The Test</h2>
                <p style="text-transform: capitalize">The RT-PCR test is not a test but a simulation. It cannot prove you are sick. A positive test doesn't necessarily mean that you have it. A negative test doesn't necessarily mean that you don't have it. The inventor of the RT-PCR Method, Kary Mullis, a Nobel Laureate, was marginalized for attacking the belief that his method could detect a virus. It can't. Learn why this test is adding to the confusion, fear and paranoia.</p>
                <p><a class="btn btn-info" href="#test" role="button">Review The Data &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img src="assets/img/tally-duotone.svg" width="75px;" height="75px" alt="">
                <h2>The Numbers</h2>
                <p style="text-transform: capitalize">The regular seasonal cold/flu deaths that occur every year have been conflated with a novel, unseen terror to induce panic and justify lock-downs. In reality even using their dubious numbers, The death rate in PA is 0.00063%. That is 6.3 ten thousandths of one percent. For those under 60, the death rate is less than 1/2 of 1 millionth of one percent or 0.0000432%. With so few deaths can this still be called a pandemic?</p>
                <p><a class="btn btn-info" href="#numbers" role="button">See The Numbers &raquo;</a></p>
            </div><!-- /.col-lg-4 -->

        </div><!-- /.row -->

        <hr class="featurette-divider non-mobile">

        <div class="row">
            <div class="col-lg-4">
                <img src="assets/img/head-side-mask-duotone.svg" width="75px;" height="75px" alt="">
                <h2 style="text-transform: capitalize;">The Surgeons</h2>
                <p style="text-transform: capitalize">did anyone think to ask surgeons about the benefits/detriments of wearings masks while driving or going to Wal-Mart? There has been a multi-generational debate going back to the early 80s as to whether or not masks in the operating theatre are a good idea. See how numerous studies show that mask wearing causes more post-op infections. </p>
                <p><a class="btn btn-info" href="#surgeons" role="button">Ask The Surgeons &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img src="assets/img/child-duotone.svg" width="75px;" height="75px" alt="">
                <h2>The Children</h2>
                <p style="text-transform: capitalize"> Children experience more pain and shortness of breath when forced to wear a mask. All children over 2 years of age are forced to wear a mask in public after enduring half a year of isolation. They have been demonized as hidden carriers of disease that will infect us all despite the missing evidence for that claim. Read our explanation here and never force your child to wear a mask again.</p>
                <p><a class="btn btn-info" href="#children" role="button"> Listen To The Children &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img src="assets/img/duck-duotone.svg" width="75px;" height="75px" alt="">
                <h2>The Quacks </h2>
                <p style="text-transform: capitalize"> The myth that breathing through homemade masks is safe and effective is dangerous quackery. These homemade masks will not protect you from a virus and could cause serious breathing or allergic issues. See this poorly designed experiment that is visibly torturing it's victims, err, participants. You'll be shocked at the lengths they will go to maintain the myth. </p>
                <p><a class="btn btn-info" href="#quackery" role="button">Observe The Quackery &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
        ...
        <div class="row">
            <div class="col-lg-4">
                <img src="assets/img/id-badge-duotone.svg" width="75px;" height="75px" alt="">
                <h2 style="text-transform: capitalize;">The Badge</h2>
                <p style="text-transform: capitalize">Get Yours Today. No Cash. No Worries. You can download it and print it out for free. Are you a business that wants to comply with the masking order but also wants to welcome those who are compliant but not wearing a mask due to an exception, <a href="#business" style="text-decoration: none">download and print your free sign </a> to help patrons here. </p>
                <p><a class="btn btn-info" href="#badge" role="button">Get The Badge &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img src="assets/img/microscope-duotone.svg" width="75px;" height="75px" alt="">
                <h2>The Experiment</h2>
                <p style="text-transform: capitalize">We are designing an experiment that will determine the level of oxygen within the masked area of the face available to breathe while wearing a mask. We will also seek to determine the amount of oxygen in the blood during prolonged mask wearing. Finally we will assess how all of this affects cognition in prolonged mask wearing events. </p>
                <p><a class="btn btn-info" href="#experiment" role="button">View The Experiment &raquo;</a></p>
            </div><!-- /.col-lg-4 -->
            <div class="col-lg-4">
                <img src="assets/img/gramophone-duotone.svg" width="75px;" height="75px" alt="">
                <h2>The Music </h2>
                <p style="text-transform: capitalize"> We are releasing 5 new songs about the pandemic, lock-downs and the likelihood for the medical authorities to advocate for the injury and harm to those who disagree with their quackery and refuse to wear a mask or accept their vaccine. These recorded songs and videos are free to download here.</p>
                <p><button class="btn btn-info disabled"  role="button" disabled> Coming Soon </button></p>
            </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->


        <!-- START THE FEATURETTES -->
        <hr class="featurette-divider" id="fifthgrader">
        ...
        <div  class="row featurette"  >
            <div class="col-md-7" >
                ...
                <p class="lead"><b><i>Let's start with the N95. </i></b> The N95 mask and the surgical mask have a curious problem that has been known to industrial hygienists and research scientists for a long time. These masks don't protect against virus and bacteria sized particles. Read the full scholarly article <a href="assets/docs/n95oshastudy2007.pdf" target="_blank" style="text-decoration: none">here</a></p><br>
                <div class="mobile quote"><img src="assets/img/article1n95conclusionnobenefit.png" width="405"  style="border: 3px solid; border-color: grey;"><br><br></div>

                <p class="lead">The N95 mask stops big particles and they also stop really tiny ones at the size of a few hundred picometers.<b><i>The curious problem with N95 masks that is also a problem for surgical masks is that they provide almost no protection against bacteria and viruses like the Coronavirus.</i></b> </p>
                <br>
                <div class="mobile quote"><img src="assets/img/article1n95conclusionnobenefit2.png" width="405"  style="border: 3px solid; border-color: grey;"><br><br></div>

                <p class="lead">  Stubborn virus and bacteria sized particles (that are 0.05 um - 0.2um in size) slip right through as if the mask wasn't filtering them at all. That is why this is a curious problem especially for the N95. It doesn't make sense because really small particles (282 pm) are stopped by the N95 mask but virus sized particles (.05um - .2um) that are much larger are not stopped or filtered.</p>
                <br>
                <div class="mobile quote"><img src="assets/img/article1n95conclusionnobenefit3.png" width="405"  style="border: 3px solid; border-color: grey;"><br><br></div>
                <p class="lead"> <b><i>N95 masks provide almost no filtering protection against particles the size of the Coronavirus.</i></b> The scientists don't have a clue on this one. This is the reason why there is so much confusion around wearing a mask because the gold standard for masks, the N95, doesn't stop viruses or bacteria and the surgical mask is 8-12 times worse. Do you think a homemade mask will do better than an N95 or a surgical mask? </p>

                <br>
                <div class="mobile quote"><img src="assets/img/article1n95conclusionnobenefit4.png" width="405"  style="border: 3px solid; border-color: grey;"><br><br></div>
                <br>
                <div class="mobile quote"><img src="assets/img/article1n95conclusionnobenefit5.png" width="405"  style="border: 3px solid; border-color: grey;"><br><br></div>
            ...
            <div class="col-md-5 non-mobile">
                ...
                <img src="assets/img/maskdebate.png" width="500"  style="border: 3px solid; border-color: grey;">
                <br>
                <br>
                <br>
                <br>
                ...
                <br>
                <br>
                <a  style="text-decoration: none" href="#surgeons"><img src="assets/img/surgeonnomaskjpg.jpg" width="500"  style="border: 3px solid; border-color: grey;"></a>
                <br>
                <br>
                <br>
                <br>
